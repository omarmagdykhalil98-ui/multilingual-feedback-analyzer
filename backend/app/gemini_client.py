...
def _generate_content(prompt: str):
    """Synchronous Gemini 2.5 content generation with retry."""
...
def classify_sentiment(text: str) -> str:
    prompt = f"Analyze the sentiment of this text and return one of these: Positive, Negative, Neutral. Text: {text}"
    return _generate_content(prompt).strip()
